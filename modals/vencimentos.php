      ...
      <table class="table table-hover" id="teste">
            ...
            <tbody><?php while($rows_vencimentos = mysqli_fetch_assoc($vencimentos)){ ?>
              <tr>
                ...
                <td><button type="button" class="btn btn-success mx-auto" data-bs-toggle="modal" data-bs-target="#renovarSolicitacao<?php echo $rows_vencimentos['id']; ?>"><i class="bi bi-check2-circle"></i></button></td>
              </tr>
